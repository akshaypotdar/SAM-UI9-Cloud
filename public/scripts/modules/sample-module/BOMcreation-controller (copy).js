define(['angular', './sample-module'], function (angular, controllers) {
    ...
    controllers.controller('BOMCreationController', ['$scope','$http','$q','SamService','$rootScope','$state','$stateParams','$filter',  function ($scope,$http,$q,SamService,$rootScope,$state,$stateParams,$filter) {
...
$scope.getAllHotSpot($scope.OrderId);
$scope.setImagePath = function(img){
...
//alert("inside selection");
	...
	//alert("$scope.loadingRow"+$scope.loadingRow);
//if($scope.loadingRow==true)
//{
    $(".score>span").text('0');
